...
// I've gotten tired of typing the whole path
var sprites = {
...
var Enemy = function() {
  ...
  // This is a little tricky. I want to replace an Enemy when it passes halfway across the screen
  // rather than waiting until it crosses the whole screen. This allows me to spread out the number
  // of enemies across the screen. Once it's halfway, I'm setting the replaced value to tell me that
  // it has been replaced. Without it, I would be trying to replace the Enemy on every update call
  // after it has moved half way across the screen. Hopefully this gives me the appearance of being
  // randomly generated.
  this.replaced = false;
